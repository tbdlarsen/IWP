...
//function for adding links in html page
function addLinks(user) {
  let links = `
   <a href="http://127.0.0.1:3001/html/help.html">help page |</a>
   <a href="http://127.0.0.1:3001">Front page |</a>
   <a href="http://127.0.0.1:3001/bmi-records?userName=${user}">Your stats |</a>  `
  return links;
}
/* ***************************************************************
